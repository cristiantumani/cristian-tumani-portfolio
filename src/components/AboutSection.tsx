        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-left">
              ...
              <p className="font-body text-lg text-foreground leading-relaxed mb-6">
                Currently based in <span className="text-accent font-medium">Barcelona</span>, I bring together <span className="font-medium">8+ years of digital product management experience</span> from both high-growth startups and established enterprises. My unique perspective comes from leading products in different cultural contexts and market conditions.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              {highlights.map((highlight, index) => (
                <div key={index} className="bg-card-gradient p-6 rounded-xl shadow-card hover:shadow-card-hover transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
