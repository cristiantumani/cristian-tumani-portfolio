...
const MoreAboutMeSection = () => {
  const interests = [
    ...
    },
    {
      icon: PersonStanding,
      title: "Running",
      description: "Running has been my passion for the last few years — it's what I call my active meditation. I'm a proud marathoner, having finished three successful marathons. So if you're up for a good life or product chat while putting some kilometers down, count on me!"
    },
    {
      icon: Plane,
      title: "Travel",
      description: "I've lived in four different countries and visited 37, but I still haven't set foot in Africa — the only continent I'm missing!"
    },
    {
      icon: Heart,
      title: "Family",
      description: "Most importantly, I'm a proud husband and father of three beautiful kids — two boys and a girl — who remind me every day what really matters."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center animate-fade-in bg-card/50 backdrop-blur-sm p-8 rounded-2xl border border-border/30 max-w-4xl mx-auto">
            <p className="font-body text-lg text-foreground leading-relaxed">
              I'm not just a product person — if you're into sports, travel, or want to chat about expat life, parenting, or personal growth, I'd love to connect!
            </p>
          </div>
